...
$\displaystyle \sum_{i=0}^{N}\sum_{j=0}^{L}c_{ijk}\boldsymbol{K}_{j}\boldsymbol{u}_{i}=\boldsymbol{f}_{k}\;,$%
...
$\displaystyle c_{k0k}\boldsymbol{K}_{0}\boldsymbol{u}_{k}=\boldsymbol{f}_{k}-\sum_{i\not=k}^{N}\sum_{j=0}^{L}c_{ijk}\boldsymbol{K}_{j}\boldsymbol{u}_{i}-\left(\sum_{j\not=0}^{L}c_{kjk}\boldsymbol{K}_{j}\right)\boldsymbol{u}_{k}\;,$%
\lthtmlindisplaymathZ
\lthtmlcheckvsize\clearpage}
...
$\displaystyle \sum_{j=0}^{L}c_{kjk}\boldsymbol{K}_{j}\boldsymbol{u}_{k}=\boldsymbol{f}_{k}-\sum_{i\not=k}^{N}\sum_{j=0}^{L}c_{ijk}\boldsymbol{K}_{j}\boldsymbol{u}_{i}\;,$%
\lthtmlindisplaymathZ
\lthtmlcheckvsize\clearpage}
