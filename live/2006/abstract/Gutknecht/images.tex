...
$\displaystyle \quad {\mathbf A}\in \mathbb{C}^{N\times N}\,,
\quad {\mathbf b}\in
...
\mathop{\mathrm{dim\  }}
{\mathcal B}_n({\mathbf A}, {\mathbf r}_0) =
\mathop{\mathrm{dim\  }}
...
{\mathcal B}_{n+1}({\mathbf A}, {\mathbf r}_0)\,,\qquad
{\mathcal B}^{\Box}_n({\mathbf A}, {\mathbf r}_0) =
...
\mathcal{K}_{\bar\nu(r_0^{(1)},{\mathbf A})}({\mathbf A}, r_0^{(1)})
+ \dots +
...
$\displaystyle \bar\nu({\mathbf r}_0,{\mathbf A})
= \min\left\{ n \big\vert {\mathbf A}^{-1} {\mathbf r}_0 \in
...
$ {\mathbf x}_{\mbox{\scriptsize $\star$}}$%
\lthtmlinlinemathZ
\lthtmlcheckvsize\clearpage}
