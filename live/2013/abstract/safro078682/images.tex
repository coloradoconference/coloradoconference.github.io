...
\begin{equation*}\begin{aligned} & \max_{x} && \sum_{ij\in E} w_{ij} x_i x_j && \\& \text{subject to} && x_i-\prod_{j\in \Gamma_i}\left(1-p_{ij} \phi_{j,t-1} x_j\right)\leq b_i && \forall i\in V,\\& && x_i \in\{0,1\} && \forall i\in V, \end{aligned}\end{equation*}%
\lthtmldisplayZ
\lthtmlcheckvsize\clearpage}
