...
$\displaystyle \vec{A}\vec{u}=\vec{b},$%
...
$\displaystyle \mathcal{P}\, u(\vec{x})=f(\vec{x})$%
\lthtmlindisplaymathZ
\lthtmlcheckvsize\clearpage}
...
$\displaystyle \int_{\Omega}\mathcal{P}\, u(\vec{x})\psi_{j}(\vec{x})\, d\vec{x}=\int_{\Omega}f(\vec{x})\psi_{j}(\vec{x})\, d\vec{x},$%
\lthtmlindisplaymathZ
\lthtmlcheckvsize\clearpage}

{\newpage\clearpage
\lthtmlinlinemathA{tex2html_wrap_inline402}%
$ \Phi(\vec{x})=\{\phi_{i}(\vec{x})\}$%
\lthtmlinlinemathZ
\lthtmlcheckvsize\clearpage}
...
$\displaystyle \vec{A}=\int_{\Omega}\Psi(\vec{x})\left(\mathcal{P}\,\Phi(\vec{x})\right)^{T}\, d\vec{x}$%
\lthtmlindisplaymathZ
\lthtmlcheckvsize\clearpage}

{\newpage\clearpage
\lthtmlinlinemathA{tex2html_wrap_inline418}%
$ \vec{b}=\int_{\Omega}\Psi(\vec{x})f(\vec{x})\, d\vec{x}$%
\lthtmlinlinemathZ
\lthtmlcheckvsize\clearpage}
...
$\displaystyle \vec{R}=\vec{R}_{\Psi}^{(1,2)}$%
\lthtmlindisplaymathZ
\lthtmlcheckvsize\clearpage}

{\newpage\clearpage
\lthtmlinlinemathA{tex2html_wrap_indisplay451}%
$\displaystyle \vec{P}=\left(\vec{R}_{\Phi}^{(1,2)}\right)^{T},$%
\lthtmlindisplaymathZ
\lthtmlcheckvsize\clearpage}

{\newpage\clearpage
\lthtmlinlinemathA{tex2html_wrap_inline453}%
$ \vec{A}^{(2)}=\vec{R}\,\vec{A}^{(1)}\vec{P}$%
\lthtmlinlinemathZ
\lthtmlcheckvsize\clearpage}
