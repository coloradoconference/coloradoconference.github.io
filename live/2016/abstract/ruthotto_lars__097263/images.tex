...
$\displaystyle d_{ijk} = p_k^T u_{ij} + e_{ijk},\quad {\rm where}\quad A(m,\omega_i) u_{ij} = q_j,$%
\lthtmlindisplaymathZ
\lthtmlcheckvsize\clearpage}

{\newpage\clearpage
\lthtmlinlinemathA{tex2html_wrap_inline161}%
$ \quad \forall i=1,\ldots,n_f, j=1,\ldots,n_s, k=1,\ldots,n_r$%
\lthtmlinlinemathZ
\lthtmlcheckvsize\clearpage}
...
$\displaystyle \min_{m} \sum_{ijk} \phi( p_{i}^\top {A}(\omega_{j},m)^{-1}q_{k} ,d_{ijk}) + \alpha R(m)\quad {\rm subject\  to } \quad m_{\rm low} \leq m \leq m_{\rm up}.$%
\lthtmlindisplaymathZ
\lthtmlcheckvsize\clearpage}
