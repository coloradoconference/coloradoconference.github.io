...
$\displaystyle p(y|\theta)\propto\exp\left(-\frac{1}{2\sigma^2}\Vert y-F(\theta)\Vert^2_2\right),
$%
\lthtmlindisplaymathZ
\lthtmlcheckvsize\clearpage}
...
$\displaystyle p(y|\theta)p(\theta)$%
\lthtmlindisplaymathZ
\lthtmlcheckvsize\clearpage}

{\newpage\clearpage
\lthtmlinlinemathA{tex2html_wrap_indisplay139}%
$\displaystyle \exp\left(-\frac{1}{2\sigma^2}\Vert
