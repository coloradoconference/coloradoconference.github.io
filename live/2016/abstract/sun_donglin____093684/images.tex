...
{\newpage\clearpage
\lthtmlinlinemathA{tex2html_wrap_indisplay95}%
$\displaystyle (A-\sigma_{i}I)X_{i} = B,~$%
\lthtmlindisplaymathZ
\lthtmlcheckvsize\clearpage}

{\newpage\clearpage
\lthtmlinlinemathA{tex2html_wrap_indisplay96}%
$\displaystyle ~i = 1, 2, \ldots, L,$%
\lthtmlindisplaymathZ
\lthtmlcheckvsize\clearpage}

{\newpage\clearpage
\lthtmlinlinemathA{tex2html_wrap_inline98}%
$ A-\sigma_{i}I \in \mathbb{C}^{n\times n}$%
\lthtmlinlinemathZ
\lthtmlcheckvsize\clearpage}
...
$ \{\sigma _{i}\}_{i = 1}^{L}\subset \mathbb{C}$%
\lthtmlinlinemathZ
\lthtmlcheckvsize\clearpage}
