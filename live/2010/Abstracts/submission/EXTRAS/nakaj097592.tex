...
\\
{\tt nakajima@cc.u-tokyo.ac.jp}\\
Kengo NAKAJIMA\end{center}
...
techniques, such as OpenMP. Another oftenÅ@used programming model is the
...
elasticity problems. The developed code has been tested on the ÅgT2K Open
SupercomputerÅh [2] using up to 512 cores. Performance of OpenMP/MPI
...
developed code has been evaluated on the ÅgT2K Open Super Computer (Todai
Combined Cluster) (T2K/Tokyo)Åh at the University of Tokyo, and
ÅgCray-XT4Åh at National Energy Research Scientific Computing Center
...
Models for Preconditioned Iterative Solvers on ÅgT2K Open
SupercomputerÅh, IEEE Proceedings of the 38th International Conference on
...
[3] Nakajima, K.: Parallel Multilevel Method for Heterogeneous Field,
