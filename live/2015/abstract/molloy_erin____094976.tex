...
``ideal'' nature of interpolation for a given $C/F$ splitting by
providing numerical evidence that hierarchies built using
$\mathbf{P}_\star$ converge more slowly
