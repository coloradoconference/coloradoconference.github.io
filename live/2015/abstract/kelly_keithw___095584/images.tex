...
$\displaystyle \Delta v(\mathbf{r}) + k^2(\mathbf{r})v(\mathbf{r}) = -s(\mathbf{r}),$%
...
$\displaystyle \phi(\pmb{r}') = \int_{\mathbb{R}^3} G(\pmb{r},\pmb{r}')\eta(\pmb{r})(\phi(\pmb{r}) + u(\pmb{r})) d\pmb{r},$%
\lthtmlindisplaymathZ
\lthtmlcheckvsize\clearpage}
