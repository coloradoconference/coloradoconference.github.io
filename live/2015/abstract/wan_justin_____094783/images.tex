...
{\newpage\clearpage
\lthtmlinlinemathA{tex2html_wrap_indisplay74}%
$\displaystyle \frac{\partial V_i}{\partial t} = LV_i - D_M(p_j)
\frac{\partial V_i}{\partial x_j} + \sup \left\{ D_i(p_i,p_j)
\left \begin{displaymath} p_i - \left( \frac{\partial V_i}{\partial x_i} - \frac{\gamma}{\beta}
\frac{\partial V_i}{\partial x_j} \right) \right] \right\} - r V_i,
\end{displaymath}
where $p_i$\  is the price for goods produced by firm $i$, and $L$\  is the
differential operator:
\begin{displaymath}L = \frac{1}{2} \sigma_1^2 \frac{\partial^2}{\partial x_1^2} + \rho \sigma_1
