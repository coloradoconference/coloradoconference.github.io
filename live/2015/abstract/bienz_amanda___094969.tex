...
sent, and the distance these messages travel.
...
larger effect on communication cost than convergence rate, and their
removal can be beneficial to the overall performance of AMG. In this talk
we give an overview of the parallel efficiency in non-Galerkin methods
and present directions that utilize topology to maximize efficiency.
