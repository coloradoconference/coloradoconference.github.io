...
\begin{displaymath}\begin{array}{l} \displaystyle \frac{{\rm d}X}{{\rm d}t}=F(X)\\[2mm] \displaystyle X(t=t_0)={\bf x} \end{array}\end{displaymath}%
\lthtmldisplayZ
...
$\displaystyle J({\bf x})=\frac{1}{2}\left({\bf x}-{\bf x}_b\right)^T{{\bf B}^{-1}}\left({\bf x}-{\bf x}_b\right)\\+\frac{1}{2}\left(H\left(X({\bf x},t)\right)-y\right){{\bf R}^{-1}}\left(H\left(X({\bf x},t)\right)-y\right)$%
...
{\newpage\clearpage
\lthtmlinlinemathA{tex2html_wrap_indisplay257}%
...
{\newpage\clearpage
\lthtmlinlinemathA{tex2html_wrap_indisplay263}%
