...
$\displaystyle Ax = b_{true} + \eta =b ,$%
\lthtmlindisplaymathZ
\lthtmlcheckvsize\clearpage}

{\newpage\clearpage
\lthtmlinlinemathA{tex2html_wrap_indisplay115}%
$\displaystyle b_{true} := A x_{true} ,$%
\lthtmlindisplaymathZ
\lthtmlcheckvsize\clearpage}
...
$\displaystyle \min_{x} \| A x - b \|_2^2 + \lambda^2 R(x), $%
\lthtmlindisplaymathZ
\lthtmlcheckvsize\clearpage}
...
$\displaystyle \min_x \| A x - b \|_2^2 + \lambda_k^2 \| D_k x \|_2^2 $%
\lthtmlindisplaymathZ
\lthtmlcheckvsize\clearpage}
