...
{\newpage\clearpage
\lthtmlinlinemathA{tex2html_wrap_indisplay147}%
$\displaystyle \frac{\partial a T_r^4}{\partial t} = - \bigtriangledown \cdot {\bf F}_r + S_r.$%
\lthtmlindisplaymathZ
\lthtmlcheckvsize\clearpage}

{\newpage\clearpage
\lthtmlinlinemathA{tex2html_wrap_indisplay149}%
$\displaystyle \rho c_{ve} \frac{\partial T_e}{\partial t} = - \bigtriangledown \cdot {\bf F}_e - S_r + S_e.$%
\lthtmlindisplaymathZ
\lthtmlcheckvsize\clearpage}

{\newpage\clearpage
\lthtmlinlinemathA{tex2html_wrap_indisplay151}%
$\displaystyle \rho c_{vp} \frac{\partial T_p}{\partial t} = - \bigtriangledown \cdot {\bf F}_p - S_e.$%
\lthtmlindisplaymathZ
\lthtmlcheckvsize\clearpage}
...
{\newpage\clearpage
\lthtmlinlinemathA{tex2html_wrap_indisplay167}%
$\displaystyle {\bf F}_r \equiv -{\sigma}_r \bigtriangledown T_r^4, \hspace{0.1in} {\bf F}_e \equiv -{\sigma}_e \bigtriangledown T_e, \hspace{0.1in} {\bf F}_p \equiv -{\sigma}_i \bigtriangledown T_p.$%
\lthtmlindisplaymathZ
\lthtmlcheckvsize\clearpage}
...
$\displaystyle S_r \equiv a c \rho \kappa_p (T_e^4 - T_r^4), \hspace{0.1in} S_e \equiv \rho c_{ve} \kappa_{pe} (T_p - T_e).$%
\lthtmlindisplaymathZ
\lthtmlcheckvsize\clearpage}
