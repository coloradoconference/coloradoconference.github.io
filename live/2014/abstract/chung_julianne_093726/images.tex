...
$\displaystyle {\bf A} \boldsymbol{\xi} + \boldsymbol{\delta} = {\bf b},$%
...
$ \boldsymbol{\delta}\in\mathbb{R}^m$%
\lthtmlinlinemathZ
\lthtmlcheckvsize\clearpage}
...
$ \mathcal{P}_{\boldsymbol{\Xi}}$%
\lthtmlinlinemathZ
\lthtmlcheckvsize\clearpage}

{\newpage\clearpage
\lthtmlinlinemathA{tex2html_wrap_inline252}%
$ \mathcal{P}_{\boldsymbol{\Delta}},$%
\lthtmlinlinemathZ
\lthtmlcheckvsize\clearpage}

{\newpage\clearpage
\lthtmlinlinemathA{tex2html_wrap_inline254}%
$ {\bf\hat Z} \in \mathbb{R}^{n \times m}$%
\lthtmlinlinemathZ
\lthtmlcheckvsize\clearpage}
...
$\displaystyle \min_{{\rm rank}({\bf Z})\leq r} \frac{1}{K} \sum_{k = 1}^K \rho({\bf Z b}^{(k)} - \boldsymbol{\xi}^{(k)})\,.$%
\lthtmlindisplaymathZ
\lthtmlcheckvsize\clearpage}
