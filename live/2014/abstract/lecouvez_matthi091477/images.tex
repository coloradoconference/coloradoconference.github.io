...
$ T\in\mathcal{L}\left(H^s(\Sigma),H^{-s}(\Sigma)\right)$%
\lthtmlinlinemathZ
...
$\displaystyle \left\{ \begin{array}{l} \partial_{n_1} u_1 +zTu_1=\partial_{n_1} u_2+zTu_2,\  \mbox{on}\  \Sigma_{12}\\\partial_{n_2} u_2 +\overline{z}Tu_2=\partial_{n_2} u_1+\overline{z}Tu_1,\  \mbox{on}\  \Sigma_{21} \end{array} \right.$%
...
$ \Lambda\in\mathcal{L}\left(H^s(\Sigma),L^2(\Sigma)\right)$%
\lthtmlinlinemathZ
\lthtmlcheckvsize\clearpage}
...
$\displaystyle \Lambda u(x)=u(x)-\beta$%
\lthtmlindisplaymathZ
\lthtmlcheckvsize\clearpage}

{\newpage\clearpage
\lthtmlinlinemathA{tex2html_wrap_indisplay164}%
$\displaystyle \int_\Sigma\left|x-y\right|^{\frac{1}{2}}\nabla u(y) d\sigma(y)$%
\lthtmlindisplaymathZ
\lthtmlcheckvsize\clearpage}
...
$\displaystyle \int_\Sigma\chi_\delta(x-y)\left|x-y\right|^{\frac{1}{2}}\nabla u(y) d\sigma(y)$%
\lthtmlindisplaymathZ
\lthtmlcheckvsize\clearpage}
