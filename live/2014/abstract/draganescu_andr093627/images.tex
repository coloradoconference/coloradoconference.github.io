...
$\displaystyle \min_{u\in L^2(\Omega)}\frac{1}{2}\|\mathcal{K} u- b\|^2 +\frac{\beta}{2}\|u\|^2\  ,
...
$ \mathcal{K}:L^2(\Omega)\to\mathcal{Y}$%
\lthtmlinlinemathZ
\lthtmlcheckvsize\clearpage}

{\newpage\clearpage
\lthtmlinlinemathA{tex2html_wrap_inline133}%
$ \mathcal{Y}\hookrightarrow L^2(\Omega)$%
\lthtmlinlinemathZ
\lthtmlcheckvsize\clearpage}
...
$ \mathcal{K}=(-\Delta)^{-1}:L^2(\Omega)\to H_0^1(\Omega)$%
\lthtmlinlinemathZ
\lthtmlcheckvsize\clearpage}
...
{\newpage\clearpage
\lthtmlinlinemathA{tex2html_wrap_indisplay155}%
$\displaystyle 1- C\frac{h^{\frac{1}{2}}}{\beta} \le \frac{\left< M_h u, u\right>}{\left< G_h u, u\right>} \le 1 + C\frac{h^{\frac{1}{2}}}{\beta},\  \ \forall u\in V_h\setminus\{0\}\  .$%
\lthtmlindisplaymathZ
\lthtmlcheckvsize\clearpage}
...
{\newpage\clearpage
\lthtmlinlinemathA{tex2html_wrap_indisplay165}%
$\displaystyle 1- C\frac{h}{\beta} \le \frac{\left< M_h u, u\right>}{\left< G_h u, u\right>} \le 1 + C\frac{h}{\beta},\  \ \forall u\in V_h\setminus\{0\}\  .$%
\lthtmlindisplaymathZ
\lthtmlcheckvsize\clearpage}
