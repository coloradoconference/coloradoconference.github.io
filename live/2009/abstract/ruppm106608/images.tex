...
$ \lambda(u) := \frac{\langle
Au, u \rangle}{\langle Mu, u \rangle}$%
\lthtmlinlinemathZ
\lthtmlcheckvsize\clearpage}
...
$\displaystyle v^{(k+1)} = v^{(k)} - c^{(k)} = v^{(k)} - B (A - \lambda(v^{(k)}) M) v^{(k)}$%
...
$\displaystyle \mathcal L ^{(k+1)}= \mathrm{span} \left\langle{c^{(k)}, v^{(k)}}\right\rangle \;.$%
\lthtmlindisplaymathZ
\lthtmlcheckvsize\clearpage}
...
$\displaystyle \min_{P} \|(I-PR^{(inj)}) S \|,$%
\lthtmlindisplaymathZ
\lthtmlcheckvsize\clearpage}

{\newpage\clearpage
\lthtmlinlinemathA{tex2html_wrap_indisplay165}%
$\displaystyle \; (I-PR^{(inj)}) S t = 0$%
\lthtmlindisplaymathZ
\lthtmlcheckvsize\clearpage}
