...
we prove the key assumptions in the general theory of Schwarz methodsformulated in \cite{SBG_1996} and use the inequalities\[C^{-1}\|v\|_{\SH}^2\leq a_h(v,v)\leq C\|\Delta v\|_{\SL}^2,\quad v\in V_h,\]obtained in \cite{Bialecki_1998}.We present numerical results that demonstrate the efficiency ofour preconditioning algorithms.\begin{thebibliography}{1}\bibitem{Aitbayev_Bialecki_2003}{\sc R.~Aitbayev and B.~Bialecki},
