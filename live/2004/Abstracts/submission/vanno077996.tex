...
\title{Optimal Time-Dependent Perturbations:
A Constraint Optimization Problem}

\begin{document}

\author{T.L. van Noorden\footnotemark[1] \and J. Barkmeijer\footnotemark[2]}
\date{}
\maketitle

\renewcommand{\thefootnote}{\fnsymbol{footnote}}

\footnotetext[1]{Utrecht University, Department of Mathematics,
Budapestlaan 6, 3584 CD, Utrecht, The Netherlands, email: noorden@math.uu.nl}
\footnotetext[2]{Royal Netherlands Meteorological Institute, PO Box 201,
