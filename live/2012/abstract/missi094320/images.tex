...
$\displaystyle \tilde Au=b$%
\lthtmlindisplaymathZ
\lthtmlcheckvsize\clearpage}

{\newpage\clearpage
\lthtmlinlinemathA{tex2html_wrap_indisplay135}%
$\displaystyle \tilde A=\left( \begin{array}{cc} A & B\\-B^{T} & 0 \end{array} \right), \;\; u= \left( \begin{array}{cc} x\\y \end{array} \right),\;\; b= \left( \begin{array}{cc} b_1\\-b_2 \end{array} \right)$%
\lthtmlindisplaymathZ
\lthtmlcheckvsize\clearpage}
