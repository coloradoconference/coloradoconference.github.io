...
Department of Informatics and Telecommunications \\ University of Athens \\ Panepistimiopolis \\ 15784 \\ Ilisisa \\ Athens \\ Greece
\\
{\tt nmis@di.uoa.gr}\\
...
part of $\ca$ \cite{Louka}, \cite{LoukMis2}.
In an attempt to generalize our theory, we introduce an additional
parameter $a$ in the structure of the matrix $\ca$, with the hope of
