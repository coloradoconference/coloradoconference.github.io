...
$\displaystyle \min_{\boldsymbol{x} \in \mathbf{R}^n}{\left\| \boldsymbol{b} - A \boldsymbol{x} \right\|_2},$%
...
$\displaystyle A^\mathsf{T} A \boldsymbol{x} = A^\mathsf{T} \boldsymbol{b}.$%
\lthtmlindisplaymathZ
\lthtmlcheckvsize\clearpage}
...
$ \kappa_2 (A) = \sigma_\mathrm{max} / \sigma_\mathrm{min}$%
\lthtmlinlinemathZ
\lthtmlcheckvsize\clearpage}
...
$ \displaystyle \min_{\boldsymbol{x} \in
\mathbf{R}^n}\| B \boldsymbol{b} - B A \boldsymbol{x} \|_2$%
\lthtmlinlinemathZ
\lthtmlcheckvsize\clearpage}
...
{\newpage\clearpage
\lthtmlinlinemathA{tex2html_wrap_indisplay207}%
$\displaystyle \boldsymbol{x}^{(l+1)} = M^{-1} N \boldsymbol{x}^{(l)} + M^{-1} A^\mathsf{T} \boldsymbol{b}, \quad l = 0, 1, \dots, \quad \boldsymbol{x}^{(0)} = \boldsymbol{0},$%
\lthtmlindisplaymathZ
\lthtmlcheckvsize\clearpage}
...
$ \displaystyle \lim_{l \rightarrow \infty} H^l$%
\lthtmlinlinemathZ
\lthtmlcheckvsize\clearpage}
