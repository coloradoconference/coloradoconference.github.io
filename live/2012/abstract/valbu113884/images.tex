...
$ \varepsilon^* = \big (
\varepsilon_r \varepsilon_o - j \frac{\sigma}{ \omega} \big )$%
\lthtmlinlinemathZ
\lthtmlcheckvsize\clearpage}
...
$ \phi_{e}(x,y,z) =
\sum_{i=1}^{8} \alpha_{i}(x,y,z) \phi_i $%
\lthtmlinlinemathZ
\lthtmlcheckvsize\clearpage}
...
$ W_{e} = \frac{1}{2}
\int_{vol} \epsilon | {\bf E_e} | ^2 d(vol) $%
\lthtmlinlinemathZ
\lthtmlcheckvsize\clearpage}

{\newpage\clearpage
\lthtmlinlinemathA{tex2html_wrap_inline233}%
$ {\bf W} = \sum_{e=1}^{N} = {\bf W_e} = \frac{1}{2}
\epsilon [\Phi]^T [C] [\Phi] $%
\lthtmlinlinemathZ
\lthtmlcheckvsize\clearpage}
...
$ \big ( \frac{\partial {\bf W}}{ \partial \phi_k} =
{\bf0} \big ) $%
\lthtmlinlinemathZ
\lthtmlcheckvsize\clearpage}
...
$ \frac{\partial {\bf W}}{ \partial \phi_k} = {\bf0} $%
\lthtmlinlinemathZ
\lthtmlcheckvsize\clearpage}
