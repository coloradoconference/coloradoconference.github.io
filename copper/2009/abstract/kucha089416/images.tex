...
$\displaystyle \tilde{m}_{n}\, \tilde{u}_{n} = m_n\, u_n + F^{m}_{n,n+1/2}\, u^*_{n+1/2} - F^{m}_{n,n-1/2}\, u^*_{n-1/2}$%
...
$\displaystyle \tilde{m}_{n} = m_n + F^{m}_{n,n+1/2} - F^{m}_{n,n-1/2} \,$%
\lthtmlindisplaymathZ
\lthtmlcheckvsize\clearpage}
...
$\displaystyle \tilde{K}_{n} = K_n + F^{K}_{n,n+1/2} - F^{K}_{n,n-1/2} \,$%
\lthtmlindisplaymathZ
\lthtmlcheckvsize\clearpage}
...
$\displaystyle F^{K}_{n,n+1/2} = F^{K}_{n+1,n+1/2} \equiv F^{K}_{n+1/2} \,$%
\lthtmlindisplaymathZ
\lthtmlcheckvsize\clearpage}
...
$\displaystyle u^{*}_{n+1/2} = \frac{ u_{n+1}\, \bar{u}_{n+1} - u_{n} \, \bar{u}_{n} - \left(u_{n+1}^2-u_{n}^2\right)/2} {\bar{u}_{n+1} - \bar{u}_{n}} \,$%
\lthtmlindisplaymathZ
\lthtmlcheckvsize\clearpage}
...
$\displaystyle D^{F} = \sum\limits_{\forall (n+1/2)} (F^{K}_{n+1,n+1/2} - F^{K}_{n,n+1/2})^2$%
\lthtmlindisplaymathZ
\lthtmlcheckvsize\clearpage}
...
$\displaystyle D^{K} = (\tilde{K} - K)^2 + \varepsilon\, K\, \sum\limits_{\forall (n+1/2)} \left( \frac{1}{2}\, m_{n+1/2}\, \left( u^*_{n+1/2} - \frac{u_{n} + u_{n+1}}{2} \right)^2 \right) \,$%
\lthtmlindisplaymathZ
\lthtmlcheckvsize\clearpage}
