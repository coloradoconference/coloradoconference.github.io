...
<?php
	...
	#-mb: include("/home/copper/public_html/2009/INFO.php");
	#-mb: include("/home/copper/public_html/2010/INFO.php");
...
# print("<body bgcolor=\"#ccaa7f\">\n<center>\n<h2>Registration</h2>\n");
# print("<body bgcolor=\"#DA9859\">\n<center>\n<h2>Registration</h2>\n");
print("<body bgcolor=\"#ccccbf\">\n<center>\n<h2>Registration</h2>\n");
print("<h3>$Year Copper Mountain Conference<br>$Topic<br>$Dates $Year</h3>\n\n");
print("<form method=\"POST\" action=\"/cgi-bin/copper2011/register.cgi\">\n\n");
?>


<table cellpadding=4>

<tr><td align=right>Name<font color=red>*</font></td>
	<td> <input type="text" name="fullname" size=40></td></tr>

<tr><td align=right>E-mail address<font color=red>*</font></td>
...
<tr><td align=right>Affiliation<font color=red>*</font></td>
	<td> <input type="text" name="affiliation" size=40></td></tr>

<tr><td align=right>Dates of planned attendance<font color=red>*</font></td>
	<td> <input type="text" name="dates" size=40></td></tr>
...
<?php
# ##############################################################################
print("<b>on or before</b></font> $DeadlineEarlyReg, $Year:<p>\n");
...
<?php
# printf("<h4>Will you be attending the banquet on %s evening?</h4>", $BanquetDay);
print("<h4>Will you be attending the banquet on $BanquetDay evening?</h4>");
?>

<!-- <h4>Will you be attending the banquet on Wednesday evening?</h4> -->
<table cellpadding=8>
<tr>
<td bgcolor="#9fef9f">
...
print("<input name=\"banquet\" type=\"radio\" value=\"YES\" checked> <b> YES </b>\n");
print("<input name=\"banquet\" type=\"radio\" value=\"NO\"> <b> NO </b>\n");

?>
</td></tr></table>

<h4>Is the attendee male or female?</h4>
<table cellpadding=8>
<tr>
<td bgcolor="#9fef9f">
<?php
...
print("<input name=\"sex\" type=\"radio\" value=\"Female\" checked> <b> Female </b>\n");
print("<input name=\"sex\" type=\"radio\" value=\"Male\"> <b> Male </b>\n");
...
<td>
	...
	<b>Credit&nbsp;Card&nbsp;ONLINE&nbsp(<i>VeriSign/PayPal</i>)</b>
...
<td>
	...
	via phone or snail mail
</td><td> (Visa or MasterCard only) Please call or mail <a href=http://grandmaster.colorado.edu/~copper/frsc.html>Front Range Scientific Computations</a>.
</td></tr>
</table>
...
-->
<p><a href="/cgi-bin/copper2011/read.cgi">Scan</a> the bulletin board for messages.
