...
$\displaystyle x_{n+1}=\xi-\theta(F^{\prime*}(x_n)F'(x_n),\alpha_n)
F^{\prime*}(x_n)\{F(x_n)-f-F'(x_n)(x_n-\xi)\} $%
...
$\displaystyle ||F(x_N)-f_\delta||^2\le \tau \delta <
...
{\newpage\clearpage
\lthtmlinlinemathA{tex2html_wrap_indisplay171}%
$\displaystyle F(x):=g \,\triangle
