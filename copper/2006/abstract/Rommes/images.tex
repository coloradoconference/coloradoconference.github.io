...
$ \mathbf{b},\mathbf{c}\in\mathbb{R}^n$%
\lthtmlinlinemathZ
\lthtmlcheckvsize\clearpage}
...
$ (\lambda_j,\mathbf{x}_j,\mathbf{v}_j)$%
\lthtmlinlinemathZ
\lthtmlcheckvsize\clearpage}
...
$\displaystyle R_j = (\mathbf{x}_j^T\mathbf{c})(\mathbf{v}_j^*\mathbf{b}).
$%
\lthtmlindisplaymathZ
\lthtmlcheckvsize\clearpage}
...
$\displaystyle H_k(s) = \sum_{j=1}^k \frac{R_j}{s - \lambda_j}. $%
\lthtmlindisplaymathZ
\lthtmlcheckvsize\clearpage}
