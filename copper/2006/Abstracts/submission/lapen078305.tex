...
equation obtained from minimization principles. The approach originates
from the seminal papers by Brackbill and Saltzmann~\cite{brackbill-jcp-82-adgrid}
and by Winslow~\cite{winslow}.
...
Brackbill-Saltzmann-Winslow~\cite{brackbill-jcp-82-adgrid,winslow}.
...
mapping~\cite{liseikin-adgrid,chacon-lapenta}. The independent
...
\bibitem{liseikin-adgrid}V.~D. Liseikin, Grid generation methods,
...
\bibitem{winslow}A.~Winslow, Adaptive mesh zoning by the equipotential method, Tech.
Rep. UCID-19062, Lawrence Livemore Laboratory (1981).
