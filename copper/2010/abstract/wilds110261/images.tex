...
$\displaystyle \min\left\{ f(x)=F[s(x)] : x\in \Omega\subseteq \mathbb{R}^n\right\},$%
...
$ \epsilon_f:=\left(\mbox{Var}\{f(t)\}\right)^{1/2}$%
\lthtmlinlinemathZ
\lthtmlcheckvsize\clearpage}
...
{\newpage\clearpage
\lthtmlinlinemathA{tex2html_wrap_indisplay157}%
$\displaystyle \sigma_k = \left(\frac{1}{m-k+1}\frac{(k!)^2}{(2k)!} \sum_{i=0}^{m-k} \left[\Delta^k f(t+ih) \right]^2\right)^{1/2}.$%
\lthtmlindisplaymathZ
\lthtmlcheckvsize\clearpage}
