...
node-to-edge Nedelec interpolation matrices \cite{ams}. We also consider
a modification of the reduction process that targets singular problems,
...
numerical simulations in the framework of \cite{discr}. The results
demonstrate that the combination of an appropriately chosen local
elimination with the use of the BoomerAMG and AMS solvers from
\cite{hypre} can lead to significant improvements in the overall solution
time.
...
{\it Parallel Auxiliary Space AMG for H(curl) Problems}, special issue on
“Adaptive and Multilevel Methods in Electromagnetics”, Journal of
