...
\hspace{-3mm}{[1]}&
\small{M.L.~Brewer. On the scaling of semiclassical initial value
methods, \emph{J. Chem. Phys.} {\bf 111} (1999)}
\\[1mm]
\hspace{-3mm}{[2]}&
\small{M.~{Gustafsson} and S.~Holmgren. An implementation framework for
solving high-dimensional PDEs on massively parallel computers, to appear
in: \emph{Proceedings of ENUMATH 2009}, Uppsala, Sweden}
\\[1mm]
\hspace{-3mm}{[3]}&
\small{S.K.~{Kim} and A.T.~Chronopoulos. A class of Lanczos-like
algorithms implemented on parallel computers, \emph{Parallel Comput.}
{\bf 17} (1991)}
\\[1mm]
\hspace{-3mm}{[4]}&
\small{K.~{Kormann}, S.~{Holmgren}, and H.O.~{Karlsson}. Accurate time
propagation for the Schr\"odinger equation with an explicitly
time-dependent Hamiltonian, \emph{J. Chem. Phys.} {\bf 128} (2008)}
\\[1mm]
\hspace{-3mm}{[5]}&
\small{K.~{Kormann} and A.~Nissen. Error Control for Simulations of a
